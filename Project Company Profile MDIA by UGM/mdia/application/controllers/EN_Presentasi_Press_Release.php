...
class EN_Presentasi_Press_Release extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['judulpers_en'] = $this->model_halaman->en_ambilpers();
        $data['gambarpers_en'] = $this->model_halaman->en_ambilpers();

        $data['judulberitapers_en'] = $this->model_berita->en_ambilpersberita();
        $data['ambildokumen_en'] = $this->model_dokber->en_ambildokumen();
            $this->load->view('EN/presentasi_press_release',$data);
	   }
