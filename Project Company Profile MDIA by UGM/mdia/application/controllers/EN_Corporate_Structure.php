...
class EN_Corporate_Structure extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['judulstrorg'] = $this->model_halaman->en_ambilstrorg();
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   		...
	   		$data['gambar2'] = $this->model_galeri->en_struktur_org();
            $this->load->view('EN/struktur-organisasi',$data);
	   }
