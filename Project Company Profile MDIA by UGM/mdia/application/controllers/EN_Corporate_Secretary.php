...
class EN_Corporate_Secretary extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['gambarsekretaris_en'] = $this->model_halaman->en_ambilsekretaris();
        $data['judulsekretaris_en'] = $this->model_halaman->en_ambilsekretaris();
        $data['isisekretaris_en'] = $this->model_halaman->en_ambilsekretaris();
            $this->load->view('EN/corporate-secretary',$data);
	   }
