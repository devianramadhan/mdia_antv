...
class Dividen extends CI_Controller {
	...
	function index(){
        ...
        $data['gambardividen'] = $this->model_halaman->ambildividen();
        $data['juduldividen'] = $this->model_halaman->ambildividen();
        $data['tahundividen'] = $this->model_dividen->tahundividen();
        $data['datadividen'] = $this->model_dividen->datadividen();

        
		$this->load->view('dividen',$data);
