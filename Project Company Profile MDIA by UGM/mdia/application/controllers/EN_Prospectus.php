...
class EN_Prospectus extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['judulpros_en'] = $this->model_halaman->en_ambilpros();
        $data['gambarpros_en'] = $this->model_halaman->en_ambilpros();
        $data['ambilpros_en'] = $this->model_berita->en_ambilberitapros();
        $data['ambildokumen_en'] = $this->model_dokber->en_ambildokumen();
            $this->load->view('EN/prospectus',$data);
	   }
