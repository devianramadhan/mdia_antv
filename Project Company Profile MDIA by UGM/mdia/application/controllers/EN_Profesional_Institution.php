...
class EN_Profesional_Institution extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   	...
	   	$data['judullembaga2'] = $this->model_halaman->en_ambiljudullembaga();
        $data['judulprofesi2'] = $this->model_berita->en_ambilprofesi();
            $this->load->view('EN/profesional-institution',$data);
	   }
