...
class EN_Contact_Us extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   		...
	   		$data['gambarkontak'] = $this->model_halaman->en_ambilkontak();
        	$data['judulkontak'] = $this->model_halaman->en_ambilkontak();
        	$data['isikontak'] = $this->model_halaman->en_ambilkontak();
            $this->load->view('EN/contact-us',$data);
	   }
