        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_slider'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              <td><a target='_BLANK' href='".base_url()."asset/img_slider/$row[gambar]'>$row[gambar]</a></td>
                              <td><center>
