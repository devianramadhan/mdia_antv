          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><input type='file' class='form-control' name='c'><hr style='margin:5px'>";
                       if ($slider['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/img_slider/$slider[gambar]'>$slider[gambar]</a>"; } echo "</td></tr>
                    <tr><th scope='row'>Keterangan</th>               
                    <td><input type='text' class='form-control' name='b' value='$slider[keterangan]'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
