  ...
  .sekolah:hover{
    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>Username<span style='color : red'> *</span></th>   
                    <td><input type='text' class='form-control' name='a' required></td></tr>
                    <tr><th scope='row'>Password<span style='color : red'> *</span></th>                 
                    <td><input type='password' class='form-control' name='b' required></td></tr>
                    <tr><th scope='row'>Nama Lengkap<span style='color : red'> *</span></th>             
                    <td><input type='text' class='form-control' name='c' required></td></tr>
                    <tr><th scope='row'>Email<span style='color : red'> *</span></th>                    
                    <td><input type='email' class='form-control' name='d' required></td></tr>
                    <tr><th scope='row'>No Telp<span style='color : red'> *</span></th>                  
                    <td><input type='number' class='form-control' name='e' required></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
