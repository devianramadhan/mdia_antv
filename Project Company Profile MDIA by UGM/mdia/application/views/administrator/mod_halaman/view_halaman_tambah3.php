   ...
   <?php 
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>ID<span style='color : red'> *</span></th>    
                    <td><input type='number' class='form-control' name='a' required></td></tr>
                    
                    <tr><th width='120px' scope='row'>Judul<span style='color : red'> *</span></th>   
                    <td><input type='text' class='form-control' name='b'></td></tr>
                    <tr><th scope='row'>Isi Halaman<span style='color : red'> *</span></th>                 
                    <td><textarea id='editor1' class='form-control' name='c' style='height:260px'></textarea></td></tr>
                    <tr><th scope='row'>Gambar</th>                    
                    <td><input type='file' class='form-control' name='d'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Title<span style='color : red'> *</span></th>   
                    <td><input type='text' class='form-control' name='f'></td></tr>
                    <tr><th scope='row'>Page Content<span style='color : red'> *</span></th>                 
                    <td><textarea id='editor2' class='form-control' name='g' style='height:260px'></textarea></td></tr>
                    <tr><th scope='row'>Picture</th>                    
                    <td><input type='file' class='form-control' name='h'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              <div class='box-footer'>
                    ...
                    <a href='halamanbaru'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
